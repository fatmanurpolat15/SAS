...
**SAS** is an AI-powered computer vision project developed to classify underwater objects from **Side-Scan Sonar (SSS)** imagery using the **YOLOv8** deep learning model.
...
The project covers the complete machine learning workflow, including synthetic dataset generation, dataset preparation, model training, model evaluation, and real-time prediction through an interactive Streamlit application.

---

## ✨ Features

- 🌊 Underwater object classification using Side-Scan Sonar imagery
...
- AI-powered underwater object classification
